		...
		proposals: [
			{
				...
				branch: 'dotvirt/proposed/admin/team-db-1a2b',
				by: 'admin',
				mine: true,
				checks: 'success',
				approvals: 0,
			...
			},
			{
				project: 'team-web',
				prNumber: 42,
				prURL: 'https://forge.example/dotvirt/team-web/pulls/42',
				title: 'web-1: exclude from the balancer',
				branch: 'dotvirt/proposed/bob/team-web-9f9f',
				by: 'bob',
				checks: 'pending',
				approvals: 0,
				requiredApprovals: 1,
