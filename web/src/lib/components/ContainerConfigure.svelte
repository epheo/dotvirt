<script lang="ts">
	...
	// The compute container's Configure tab: read-only project settings. dotvirt
	// owns nothing here — projects are namespace labels, config is the repo.
	// Node and segment facts live on their own object pages.
