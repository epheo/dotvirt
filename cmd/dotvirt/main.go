...
// and ArgoCD. It is a thin multi-tenant lens: every request runs under the caller's
// own k8s token, and a project is a set of namespaces (a cluster fact) backed by its
// own git repo.
package main
